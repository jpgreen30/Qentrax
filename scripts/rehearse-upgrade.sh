...
LATEST_MIGRATION_FILE="$(printf '%s\n' "$ROOT"/supabase/migrations/*.sql | sort | tail -1)"
LATEST_MIGRATION_VERSION="$(basename "$LATEST_MIGRATION_FILE" .sql)"
LATEST_MIGRATION_VERSION="${LATEST_MIGRATION_VERSION%%_*}"
DELTA_END="${DELTA_END:-$LATEST_MIGRATION_VERSION}"
