...
| Create/link Supabase project | `NEXT_PUBLIC_SUPABASE_URL`, `NEXT_PUBLIC_SUPABASE_ANON_KEY`, `SUPABASE_SERVICE_ROLE_KEY`, `DATABASE_URL` | Phase 0 authenticated exit test | Migrations apply and email sign-in reaches organization shell |
