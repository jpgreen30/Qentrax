...
export default async function AdvertiserTeam({
  searchParams,
}: {
  ...
  return (
    <WorkspaceShell
      ...
      title="Team"
      subtitle="People with access to this advertiser workspace."
    >
      <div className="dashStats">
        ...
        <article>
          ...
          <strong style={{ fontSize: 18 }}>ADVERTISER</strong>
          <small>PORTAL</small>
        </article>
        <article>
          <header>
      ...
      <article className="dashPanel metricsNote">
        ...
        <p style={{ marginTop: 12 }}>
          <Link href={`/workspace/advertiser?org=${org.id}`} className="dashGhost">
            ← Back to overview
          </Link>
        </p>
      </article>
