...
<p>Figures shown are modeled program outcomes for illustrative configurations, not claims of historical client performance. Verified results can replace them as programs mature.</p>
 ...
 <footer className="sitefoot shell"><a className="brand" href="#top"><i>Q</i>QENTRAX</a><p>The AI-native marketplace for consumer demand.</p><div><a href="#platform">Platform</a><a href="#case-studies">Case Studies</a><Link href="/blog">Blog</Link><a href="#about">About</a><a href="#contact">Contact</a></div><small>© 2026 QENTRAX, INC. · ALL SYSTEMS OPERATIONAL</small></footer>
 </main>}
