...
export default function Home(){return <main>
 ...
 <section className="intelligence" id="insights"><div className="shell"><header className="splitHead"><div><label>06 / SIGNALS</label><h2>Signals worth<br/>paying attention to.</h2></div><p>Analysis and practical guidance for teams buying, monetizing and operationalizing consumer demand.</p></header><div className="signalGrid" style={{gridTemplateColumns:"repeat(3,1fr)"}}>
  <article><span>01</span><label>Q-SHIELD / LEAD QUALITY</label><p style={{marginTop:12}}>Why single-point lead validation is no longer enough</p><p style={{fontSize:11,color:"#7a8b8f",marginTop:16}}>Fraud is a pattern, not a field. Learn how network-level signals expose risk that isolated checks miss.</p><a href="#contact" style={{position:"absolute",bottom:25,font:"8px var(--mono)",color:"var(--acid)"}}>READ THE BRIEFING ↗</a></article>
...
<p>Figures shown are modeled program outcomes for illustrative configurations, not claims of historical client performance. Verified results can replace them as programs mature.</p>
 ...
 <footer className="sitefoot shell"><a className="brand" href="#top"><i>Q</i>QENTRAX</a><p>THE AI-NATIVE MARKETPLACE FOR CONSUMER DEMAND.</p><div><Link href="/advertiser">Advertisers</Link><Link href="/publisher">Publishers</Link><Link href="/blog">Field Notes</Link><a href="#security">Q-Shield</a><a href="#contact">Contact</a></div><small>© 2026 QENTRAX. ALL RIGHTS RESERVED.</small></footer>
 </main>}
